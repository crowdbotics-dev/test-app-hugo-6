"""
Django settings for test_app_hugo_6 project.
...
ROOT_URLCONF = 'test_app_hugo_6.urls'
...
WSGI_APPLICATION = 'test_app_hugo_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_app_hugo_6 API",
    "DESCRIPTION": "API documentation for test_app_hugo_6 App",
    "VERSION": "v1",
}
